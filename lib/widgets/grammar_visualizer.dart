...
class _GrammarVisualizerState extends State<GrammarVisualizer> {
  ...
  Widget _buildVisualStructure(List<String> components) {
    ...
    if (widget.structureBreakdown != null &&
        widget.structureBreakdown!.isNotEmpty) {
      return Wrap(
        spacing: 8,
        runSpacing: 12,
...
class AnimatedGrammarVisualizer extends StatefulWidget {
  ...
  @override
  State<AnimatedGrammarVisualizer> createState() =>
      _AnimatedGrammarVisualizerState();
}

class _AnimatedGrammarVisualizerState extends State<AnimatedGrammarVisualizer>
  ...
  List<Widget> _buildAnimatedStructureBreakdown() {
    return List.generate(widget.structureBreakdown!.length, (index) {
      ...
      final color =
          _colorsLoaded && _colors.containsKey(part.partOfSpeech.toLowerCase())
          ? _colors[part.partOfSpeech.toLowerCase()]!
          : _getComponentColor(part.text);
      ...
      return AnimatedBuilder(
        ...
        builder: (context, child) {
          ...
          final startTime =
              index *
              componentDuration.inMilliseconds /
          ...
          return FadeTransition(
            ...
            child: SlideTransition(
              ...
              child: Container(
                ...
                decoration: BoxDecoration(
                  color: color.withValues(alpha: 0.1 * animation.value),
                  borderRadius: BorderRadius.circular(8),
                  border: Border.all(
                    color: color.withValues(alpha: 0.6 * animation.value),
                    width: 1,
                  ),
                ),
                child: Text(
