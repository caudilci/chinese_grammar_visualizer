          ...
          Row(
            ...
            children: [
              TextButton.icon(
                ...
                onPressed: provider.activeSession!.currentItemIndex > 0
                    ? () => provider.moveToPreviousItem()
                    : null,
              ),
              TextButton.icon(
                icon: const Icon(Icons.arrow_forward),
                label: const Text('Skip'),
                onPressed: provider.activeSession!.currentItemIndex < 
